...
import TransitionWrapper from "./wrappers/transition-wrapper"; // Assuming this path
          ...
          <div className='px-1 py-1 space-y-2'>
            ...
            <MenuItem>
              {({  }) => (
                <button
                  onClick={addMoney}
                  className='group flex gap-2 w-full items-center rounded-md px-2 py-2 text-sm text-gray-700 dark:text-gray-200' // Added dark:text-gray-200 for dark mode
                >
                  <FaMoneyCheckDollar />
                  Add Money
                </button>
